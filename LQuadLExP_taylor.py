...
print 'norm( U.T V2 V1[i,:] U ) = ', [ L.norm(dot(U.T*V2*V1[i,:],U)) \
                                        for i in range(NRGC)]
...
print 'true params = ', baye.params(true_params,data[0])[index]
print 'opt  params = ', baye.params(opt_params ,data[0])[index]