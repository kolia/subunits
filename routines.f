...
c================    L-BFGS-B (version 2.1)   ==========================
      ...
      subroutine setulb(n, m, x, l, u, nbd, f, g, amax, factr, pgtol, 
     +                  wa, iwa, task, iprint,  csave, lsave, isave, 
     +                  dsave, d)
     ...
     +                 nbd(n), iwa(3*n), isave(44)
      double precision f, amax, factr, pgtol, x(n), l(n), u(n), g(n),
     +                 wa(2*m*n+4*n+12*m*m+12*m), dsave(29), d(n)
...
c======================= The end of setulb =============================
     ...
     +                  iprint, csave, lsave, isave, dsave, amax)
 
      character*60     task, csave, old_task
      logical          lsave(4)
      integer          n, m, iprint, nbd(n), index(n),
     +                 iwhere(n), indx2(n), isave(23)
      double precision f, amax, factr, pgtol,
...
c     KOLIA temporary task: find largest step size amax
      old_task = task
      task = 'BARRIER'

c     KOLIA: return to python driver to get amax, re-enter at 88
      goto 1000
 ...
 88   continue
     ...
     +            boxed,cnstnd,csave,isave(22),dsave(17),amax)
